...
<body>
	<div class="mui-card">
		<ul class="mui-table-view">
			...
			<li class="mui-table-view-cell"><font size="4"><b>第一志愿:【<%=request.getAttribute("firstvoluntary") %>】</b></font></li>
			<li class="mui-table-view-cell">一、二、三志愿报此专业共<%=request.getAttribute("listSize")%>人，你的排名:<%=request.getAttribute("sort1")%></li>
			<li class="mui-table-view-cell"><font size="4"><b>第二志愿:【<%=request.getAttribute("secondvoluntary") %>】</b></font></li>
			<li class="mui-table-view-cell">一、二、三志愿报此专业共<%=request.getAttribute("listSize2")%>人，你的排名:<%=request.getAttribute("sort2")%></li>
			<li class="mui-table-view-cell"><font size="4"><b>第三志愿:【<%=request.getAttribute("thirdvoluntary") %>】</b></font></li>
